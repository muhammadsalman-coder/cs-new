...
export const bids = [
  {
    title: "ChainCollection",
    price: "2.45 BNB",
    highestBid: "2.45 BNB",
    counter: "3 in stock",
    bid: 'New bid <span role="img" aria-label="fire">🔥</span>',
    image: "./images/content/pic1.png",
    image2x: "./images/content/pic1.png",
    category: "green",
    categoryText: "purchasing !",
    url: "/",
    users: [
      {
        avatar: "./images/icons/icon32.png",
      },
      {
        avatar: "./images/icons/icon31.png",
      },
      {
        avatar: "./images/icons/icon30.png",
      },
    ],
  },
  {
    ...
    counter: "3 in stock",
    bid: 'New bid <span role="img" aria-label="fire">🔥</span>',
    image: "./images/content/pic2.png",
    image2x: "./images/content/pic2.png",
    category: "green",
    categoryText: "purchasing !",
    url: "/",
    users: [
...
export const dicoverCards = [
  {
    title: CATEGORY_NAMES[2],
    index: 2,
    image: "./images/content/discover/football.jpeg",
    image2x: "./images/content/discover/football.jpeg",
    category: "green",
    categoryText: "purchasing !",
    url: "/",
  },
  {
    ...
    index: 3,
    image: "./images/content/discover/music.jpeg",
    image2x: "./images/content/discover/music.jpeg",
    category: "green",
    categoryText: "purchasing !",
    url: "/",
  },
  {
    ...
    index: 0,
    image: "./images/content/discover/allnft.jpeg",
    image2x: "./images/content/discover/allnft.jpeg",
    category: "green",
    categoryText: "purchasing !",
    url: "/",
  },
