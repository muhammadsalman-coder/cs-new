...
const Mint = () => {
  ...
  useEffect(() => {
    connectContract("0xd17237f0B1eDb8109F7E0937165Fd58aDAd2Ca11", abi).then(
      (c) => {
        setContract(c);
      }
    );
      ...
      */}
      ...
      <About className="about">
        ...
        <div className="about__info">
          ...
          <s.SpacerMedium />
          <Para>
            Get your first Metaverse Land. The RABP NFT Metaverse is offering
            their 1st phase of Metaverse land plots in our Central Business
            District located along Fashion Street. This area of Prime Land is in
            as area named RABP Market Square is earmarked for small to medium,
            high street fashion boutique, shops, sneakers, restaurants,
      ...
      <s.Container2>
        ...
        <s.SpacerMedium />
        <Para>
          Earmarked as a high-rise district the land in this area should quickly
          accumulate value as more and more businesses seek out real-estate to
          market, sell and promote their real world and virtual products and
          services Total Land Allocation: 500 Plots Pricing 0.1ETH per Plot
        </Para>
      </s.Container2>
      <s.SpacerLarge />
      <s.Container2>
        ...
        <s.SpacerMedium />
        <Para>
          Our Metaverse is designed to unlock a new world of digital commerce
          and income opportunities for both our RABP NFT citizens and visitors.
          Our project is dedicated to tradeable Multi-chain NFTs, Metaverse,
          Retail, Gaming, Virtual Marketing, Virtual Learning, Galleries, Real
          Estate, Auctions, Expos, Conferences, Networking, E-commerce and much
          more. Our RABP NFT holder citizens will be 1st in line in the
          allocation and purchase of the vast assets available in our Metaverse,
          from land, to retail space, digital merchandise, real estate,
          transport services, advertising billboards, gaming opportunities,
          e-learning and much, much more. Only our citizens will have access to
          1st hand asset ownership. Our mission is to provide the best
          multi-chain NFT powered metaverse across the globe to improve
          awareness and encourage innovation and exchange of ideas around the
          metaverse economy and its vast future.
        </Para>
      </s.Container2>
      <s.SpacerLarge />
      <div>
        <Heading>Refined Land Miniting</Heading>
        <s.SpacerMedium />
        <div
          style={{
        ...
        >
          <div style={{ marginBottom: "1.5rem" }}>
            <Heading>Refined Land MINTING:</Heading>
            <ul>
              {/* <li>
              ...
              <li>
                <s.Container jc={"space-between"} ai={"center"} fd={"row"}>
                  <Para>PUBLIC SALE: Live </Para> {/* <Para>  </Para> */}
                </s.Container>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul>
              <li>
                <Para>BSC Starts at 0.7BNB + GAS</Para>
              </li>
            </ul>
          </div>
        </div>
      ...
      <p style={{ width: "100%", textAlign: "center" }}>
        Copyright ©️ 2022 Refined Apes Block Party (R.A.B.P). All rights
        reserved
      </p>
      <s.SpacerLarge />
    </s.Screen>
