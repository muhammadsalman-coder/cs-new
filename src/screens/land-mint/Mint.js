...
const Mint = () => {
  ...
  useEffect(() => {
    ///@notice RefinedLand BSC Mainnet
   connectContract('0xd17237f0B1eDb8109F7E0937165Fd58aDAd2Ca11', abi).then(c => {
     setContract(c);
   })

   ///@notice RefinedLand Rinkeby Testnet
  //  connectContract("0x7Bd6625698541d22B9F36c1d2fB8db758ac511eF", abi).then(c => {
  //      setContract(c);
  //    }
  //  );
    ...
    <s.Screen>
      ...
      */}
        ...
        >
          <div style={{ marginBottom: "1.5rem" }}>
            ...
            <ul>
              ...
              <li>
                <s.Container jc={"space-between"} ai={"center"} fd={"row"}>
                  <Para>PUBLIC SALE 21:00EST </Para> {/* <Para>  </Para> */}
                </s.Container>
              </li>
            </ul>
          </div>
      ...
      <p style={{ width: "100%", textAlign: "center" }}>
        Copyright ©️ 2021 Refined Apes Block Party (R.A.B.P). All rights
        reserved
      </p>
      <s.SpacerLarge />
    </s.Screen>
