...
const items = [
  ...
  {
    title: "Trading on ChainCollection",
    icon: "home",
  },
  // {
  //   title: "Support",
          ...
          <div className={styles.col}>
              ...
              <>
                ...
                <Item className={styles.item} item="How do I search for NFT’s?">
                  <p>
                    ...
                    you've come to the right place. At ChainCollection, there
                    are many ways to search through thousands of NFTs. If you
                    know what you're looking for, you can search directly in the
                    "search bar".
                  </p>
            ...
            {activeIndex === 1 && (
              <>
                <Item
                  className={styles.item}
                  item="Creating a ChainCollection Account"
                >
                  <p>
                    Follow the given steps to create your account and start
                    trading NFTs on ChainCollection:
                  </p>
                  <ol>
                    <li>
                    ...
                    <li>
                      <h3>ChainCollection</h3>
                      <p>
                        You now need to connect your wallet to ChainCollection
                ...
                >
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      Ethereum blockchain transaction costs. ChainCollection
                      does not contribute in setting gas fees – they are
                      determined by supply/demand across the network
                      (blockchain).
                    </li>
                    ...
                    <li>
                      ...
                      an ChainCollection collection as a store or gallery, don’t
                      get confused – it’s all the same. We use the term
                      collection to keep things simple.
                    </li>
                  </ul>
                </Item>
                <Item
                  className={styles.item}
                  item="How do i edit my ChainCollection profile"
                >
                  <p>
                ...
                <Item
                  className={styles.item}
                  item="How do I log out of my ChainCollection account?"
                >
                  <p>
                    To log out of your ChainCollection account, kindly follow
                    the steps below. Go to the profile icon on the top right of
                    the screen. On the dropdown menu click on "Log Out".
                  </p>
                  <img src="/images/faq/q3-1.png" alt="" />
                </Item>
                <Item
                  className={styles.item}
                  item="How to I subscribe the ChainCollection newsletter?"
                >
                  <p>
                    You can subscribe the ChainCollection newsletter from footer
                  </p>
                ...
                <Item
                  className={styles.item}
                  item="ChainCollection supported Blockchains"
                >
                  <p>
                    ChainCollection provides support across three different
                  ...
                  <div className={styles.chainContainer}>
                    ...
                    <p>
                      ...
                      the Ethereum blockchain. ChainCollection has no say in
                      setting gas fees – they are determined by supply/demand
                      and fluctuate according to network usage.
                    </p>
                  </div>
                  <div className={styles.chainContainer}>
                    <h3>Polygon</h3>
            ...
            {activeIndex === 2 && (
              <>
                <Item
                  className={styles.item}
                  item="How do I follow or unfollow a profile on ChainCollection?"
                >
                  <p>
                    You can follow or unfollow a profile / user on
                    ChainCollection from the profile page of that user
                  </p>
                ...
                <Item
                  className={styles.item}
                  item="How do I share a profile from ChainCollection to other social sites"
                >
                  <p>
                    You can share a profile from ChainCollection to other social
                    sites by going to the profile that you want to share and
                    click the share icon besides follow / unfollow button and
                    then select the social site where you want to share that
                    profile
                  </p>
                ...
                <Item
                  className={styles.item}
                  item="How do I report a profile on ChainCollection
              "
                >
                  <p>
                    You can report a profile on ChainCollection by going to the
            ...
            {activeIndex === 3 && (
              <>
                ...
                <Item
                  className={styles.item}
                  item="How can I purchase an item on ChainCollection?"
                >
                  <p>
