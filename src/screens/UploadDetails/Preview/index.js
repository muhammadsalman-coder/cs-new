  ...
  const getMintPrice = React.useCallback(async () => {
    if (contracts.closedSeaNft) {
      let mintFee = await contracts.closedSeaNft.methods
        .mintPriceInETH()
        .call();
      const exemptThreshold = await contracts.closedSeaNft.methods
          ...
          <div className={styles.link}>
            <div className={styles.body}>
              <div className={styles.line}>
                ...
                <div className={styles.value}>
                  {data.name ? <b>{data.name}</b> : "No set"}
                </div>
              ...
              <div className={styles.line}>
                <div className={styles.title}>External Link:</div>
                <div className={styles.value}>
            ...
            <div className={styles.foot}>
              ...
              <div className={styles.bid}>
                ...
                parseFloat(seaAmountForExemptFee)
                  ? "0 BNB"
                  : `${mintPrice} BNB`}
              </div>
            </div>
