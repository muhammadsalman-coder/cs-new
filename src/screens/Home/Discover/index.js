...
// data
import { dicoverCards } from "../../../mocks/discover";
...
navLinks.map((x) => sortingOptions.push(x.text));
    ...
    <div className={cn("section", styles.section)}>
      <div className={cn("container-fluid", styles.container)}>
        ...
        <div className={styles.top}>
          ...
          {/* <button
            className={cn("btn-square button-stroke", styles.filter, {
        ...
        <div className={styles.list}>
          <Slider
            ...
            {...settings}
          >
            {dicoverCards.map((x, index) => (
              <CardDiscover className={styles.card} item={x} key={`${x.title}`} />
            ))}
          </Slider>
        </div>
