...
const Mint = () => {
  ...
  useEffect(() => {
    ///@notice RefinedApe mainnet
    connectContract('0x1E9d0B8c346B594b1dA6C637754b5b2E91eEA1aC', abi).then(c => {
      // console.log("c: ", c);
      setContract(c);
    })

    ///@notice RefinedApe Rinkeby Testnet
    // connectContract("0xE8c75D8c67b92B167F2C64B7D52c54d7c46DaF9c", abi).then(
    //   (c) => {
    //     console.log("rapb-mint testnet: ",c)
    //     setContract(c);
    //   }
    // );
        ...
        <div className="hero__container">
          ...
          <s.Container flex={1} ai={"center"}>
            <ResponsiveWrapper flex={1} style={{ padding: 10 }} test>
              <StyledMint2
                target="_blank"
                href="https://closedsea.medium.com/refined-apes-why-i-should-participate-in-the-public-sale-6d9567aa4697"
              >
