...
function CardHero({ infoImg, myLink, name }) {
  ...
  const navigateToCollection = () => {
    const linkss = myLink.split("/");

    history.push(
      linkss[linkss.length - 3] +
        "/" +
        linkss[linkss.length - 2] +
        "/" +
        linkss[linkss.length - 1]
    );
  };
  return (
    // <div className="container-fluid">
    infoImg ? (
      <div className={styles.root} onClick={navigateToCollection}>
        {/* <Link> */}
