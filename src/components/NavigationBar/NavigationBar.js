...
const DropdownItem = (props) => {
  return props.inputt ? (
    ...
    <Link to={props.link} href="#" className={styles.menuItem}>
...
function DropdownMenu() {
  ...
  return (
    <div className={styles.dropdown}>
      ...
      <DropdownItem link="/search01" leftIcon={<BiWorld />}>
        Discover
      </DropdownItem>
      <DropdownItem link="#" leftIcon={<BiSupport />}>
        Help and Support
      </DropdownItem>
      ...
      <DropdownItem inputt={true} handleSubmit={handleSubmit}>
        <input
