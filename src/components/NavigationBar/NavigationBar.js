...
function Navbar(props) {
  ...
  let themeVariant = window.localStorage.getItem("darkMode");
  return (
      ...
      <div className={styles.navbarLeft}>
        <Link className={styles.logo} to="/">
          <Image
            ...
            src="./logo/newlogo/logobb2.png"
            srcDark="./logo/newlogo/logow33.png"
            alt="Closed Sea Logo"
          />
        </Link>
        <form onSubmit={handleSubmit} style={{ position: "relative" }}>
          <div className={styles.inputContainer}>
            <input
              ...
              type="text"
              placeholder="Search ChainCollection NFTs & NFT Games Multi-Chain Marketplace"
...
const NavigationBar = () => {
  ...
  return (
    <>
      ...
      <ReactTooltip id="collection" place="top" type="dark" effect="solid" />
